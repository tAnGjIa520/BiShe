...
class DualDehazeFormer(nn.Module):
	def __init__(self, in_chans=3, out_chans=4, window_size=8,
				 ...
				 norm_layer=[RLN, RLN, RLN, RLN, RLN], n_channels=None, n_classes=None, bilinear=None):
		super(DualDehazeFormer, self).__init__()
