...
parser.add_argument('--model', default='dualdehazeformer-l', type=str, help='model name')
...
def test(test_loader, network, result_dir):
	...
	for idx, batch in enumerate(test_loader):
		...
		# print("{},{},{}".format(result_dir, 'imgs', filename))
...
if __name__ == '__main__':
	...
	if os.path.exists(saved_model_dir):
		print('==> Start testing, current model name: dual' + args.model)
